...
from bilipy_bot.sources.bilibili.data import DanmakuGiftData, DanmakuMsgData
from bilipy_bot.sources.bilibili.data.dto import DanmakuGiftDTO, DanmakuMsgDTO
    ...
    async def main():
        ...
        async def on_live(msg):
            ...
            file_path = os.path.join(
                os.path.dirname(os.path.abspath(__file__)), "live_sta.json"
            )
