...
from bilipy_bot.sources.bilibili.data import DanmakuMsgData, DanmakuGiftData
from bilipy_bot.sources.bilibili.data.dto import DanmakuMsgDTO, DanmakuGiftDTO
