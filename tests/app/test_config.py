...
from bilipy_bot.app.config import RuntimeConfig, register_builder
...
class TestRuntimeConfigFromYaml:
    ...
    @patch("bilipy_bot.app.config.yaml.safe_load")
...
def _get_builders_copy() -> dict:
    ...
    from bilipy_bot.app.config import _CONFIG_BUILDERS
